      ...
      <div v-if="modelValue" class="m-dialog" @click.self="handleBackdropClick">
        <div class="m-dialog__container">
          <div class="m-dialog__content">
            <div class="m-dialog__icon" v-if="showIcon">
...
.m-dialog__icon svg :deep(path),
.m-dialog__icon svg :deep(circle),
.m-dialog__icon svg :deep(rect) {
  fill: #ffa726;
  stroke: #ffa726;
}

.m-dialog__icon svg :deep(path[fill="rgba(0,0,0,0)"]) {
